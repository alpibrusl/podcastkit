"""Generate all voice lines for AGREEABLE Episode 5 via ElevenLabs.
...
CHEN was introduced in Episode 4. Reuse the same ElevenLabs voice_id you
picked there to keep him consistent across episodes.
...
VOICES = {
    ...
    # TODO: same voice_id you picked for CHEN in episode 4.
